...
ready.onclick = ()=>{
    question.innerText = "Người chơi đã sẵn sàng, chúng ta cùng bắt đầu đi tìm ai là triệu phú";
...
function generateRandomNumber(num) {
    return Math.floor(Math.random() * num+1); // Tạo số ngẫu nhiên từ 0 đến 90 (bao gồm cả 0 và 90)
  }